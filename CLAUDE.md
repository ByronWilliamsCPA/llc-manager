...
docker build -t llc_manager .  # Build production image
```
...
```python
from llc_manager.utils.logging import setup_logging, get_logger
...
```python
from llc_manager.middleware.correlation import (
    set_correlation_id,
...
../llc_manager-worktrees/

# Quick reference commands
git worktree add ../llc_manager-worktrees/feature-name -b feature/feature-name
git worktree add ../llc_manager-worktrees/pr-42 origin/feature/pr-branch
git worktree list
git worktree remove ../llc_manager-worktrees/feature-name
```
