...
git remote add origin https://github.com/ByronWilliamsCPA/llc-manager.git
...
The planning workflow generates 4 core documents, then synthesizes them into a project plan:
...
Use the included script to configure branch protection rules:
...
2. **Security Contact**: Change `security@williamscpa.com` if needed
