...
_DEFAULT_SECRET_KEY_PLACEHOLDER = "change-me-in-production"  # noqa: S105  # nosec B105 -- startup sentinel; _reject_default_secret_key_outside_dev rejects it outside development
