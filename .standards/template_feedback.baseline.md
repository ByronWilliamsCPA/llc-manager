...
`llc_manager/.github/workflows/`.

**Affected Files**:
- `llc_manager/.github/workflows/ci.yml`
- `llc_manager/.github/workflows/release.yml`
- `llc_manager/.github/workflows/docs.yml`
